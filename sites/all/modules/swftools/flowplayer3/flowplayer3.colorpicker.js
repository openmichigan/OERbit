// $Id: flowplayer3.colorpicker.js,v 1.1.2.1 2009/03/17 21:21:16 stuartgreenfield Exp $

// This file is basically lifted from the color module, but it needs some tidying up,
// and at the moment the neat "linked colors" feature isn't working. However, it is
// usable as a quick color scheming feature.

Drupal.behaviors.color = function (context) {
  // This behavior attaches by ID, so is only valid once on a page.
  if ($('#flowplayer3_scheme_form .color-form.color-processed').size()) {
    return;
  }
  var form = $('#flowplayer3_scheme_form .color-form', context);
  var inputs = [];
  var hooks = [];
  var locks = [];
  var focused = null;
  ...
  $('#edit-flowplayer3-scheme', form).change(function () {
...
//      }
  ...
  function resetScheme() {
    $('#edit-flowplayer3-scheme', form).each(function () {
